...
class Helmholtz2D(VectorizedTask):
    ...
    def loss_fn(self, pred, X_batch, Y_batch, bcs_masks):
        ...
        jax.debug.print("r_all={:},pde_loss={:},ic_loss={:},bc_loss={:},data_loss={:}", jnp.sum(r_all**2), pde_loss, ic_loss, bc_loss, data_loss)
        return loss
