...
from src.utils import SimManager, multi_SimManager, addbc, stack_outputs, DataLoader
...
class Burgers2D(VectorizedTask):
    def __init__(self, hidden_layers=None, datapath='../ref/burgers2d_0.dat',
...
seeds = 0
train_task = Burgers2D(hidden_layers='12*4')
