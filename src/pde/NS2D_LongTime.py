...
class NS2D_LongTime(VectorizedTask):
    def __init__(self, datapath =ref_dir/'ns_long.dat', nu=1 / 100, bbox=[0, 2, 0, 1, 0, 5]):
        # --- 基础设置 ---
        self.max_steps = 1
       ...
       # --- 加载监督数据 ---
        ...
        # --- mini-batch 设置 ---
        self.BatchSize_eq = BatchSize_eq         # 定义在全局或 __init__ 参数
        self.BatchSize_data = BatchSize_data     # 同上
        domain_bounds = [
