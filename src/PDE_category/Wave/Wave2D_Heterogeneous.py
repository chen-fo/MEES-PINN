...
class PDE(VectorizedTask):
    def __init__(self, hidden_layers=None, datapath=ref_dir/'wave_darcy.dat', bbox=[-1, 1, -1, 1, 0, 5], mu=(-0.5, 0), sigma=0.3):
        # --- 基础设置 ---
        self.max_steps = 1
        ...
        self.mu = mu
        self.sigma = sigma
        self.darcy_2d_coef = np.loadtxt(ref_dir/'darcy_2d_coef_256.dat')
